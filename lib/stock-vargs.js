...
module.exports = function stock_vargs(f, _stock_left, _is_stock_left_holey, _stock_right, _is_stock_right_holey, _l_stock_i_min, _r_stock_i_min){
  return function(){
    ...
    if (is_delayed_execution) {
      return stock_vargs(f, stock_left, is_stock_left_holey, stock_right, is_stock_right_holey, l_stock_i_min, r_stock_i_min) ;
    } else {
