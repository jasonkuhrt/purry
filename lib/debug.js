...
var to_array = function(args){ return Array.prototype.slice.apply(args); };
...
exports.state = function(){
  console.log('%s', format_stock(arguments[1], arguments[2], arguments[3], arguments[0], arguments[4]));
};
